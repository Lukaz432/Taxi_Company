    ...
    row: {
        ...
        build: function (data) {
            ...
            Object.keys(data).forEach(data_id => {
                ...
                } else if (data_id == 'price' && data.discount_price > 0) {
                    let p = document.createElement('p');
                    p.className = data_id;
                    p.className += 'striked';
                ...
                } else if (data_id == 'discount_price') {
                    let discounts = data.price - (data.price * data.discount_price / 100);
                    let p = document.createElement('p');
                    p.className = discounts;
                    p.innerHTML = 'Discount' + discounts.toFixed(2) + 'Eur';
